...
<body>
	<div id="shop_title_box" style="margin-left:0px ;padding:0; width: 98%;">			
			...
			<div id = "shop_title_test" style="font-size: 18px;"> <?php echo $this->tank_auth->get_hotel_name();?> Invoice Details</div>
			<div id = "shop_address_test" style="font-size: 14px;">Date Wise Entertainment Invoices</div>
	...
	<div class="CSSTableGenerator"  style="margin:10px 0px;padding:0; width: 98%;">
		<table>
			...
			<?php
				...
				$total_receivable = 0;
				$total_received = 0;
				foreach($entertainment_setups -> result() as $field):
			?>
			<tr>
				<td> <?php echo $index; ?> </td>
				<td> <?php echo $field -> order_id; ?> </td> 
				
		        <td style="text-align:left"> <?php echo $field -> username; ?>  </td>
