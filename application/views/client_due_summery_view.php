...
<body>
	<div id="shop_title_box" style="margin-left:0px ;padding:0; width: 98%;">			
			...
			<div id = "shop_address_test" style="font-size: 16px;">Clients Due Report</div>
			...
			<div id = "shop_address_test" style="font-size: 13px;">Client Name: <?php echo $username; ?> </div>
			<?php }
			?>
	...
	<div class="CSSTableGenerator"  style="margin:10px 0px;padding:0; width: 98%;">
		<table>
			...
			<?php
				...
				$total_receivable = 0;
				$total_received = 0;
				foreach($client_due_summery_setups -> result() as $field):
			?>
			<tr>
