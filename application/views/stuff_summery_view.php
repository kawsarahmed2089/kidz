...
<body>
	<div id="shop_title_box" style="margin-left:0px ;padding:0; width: 98%;">			
			...
			<div id = "shop_address_test" style="font-size: 16px;">Date Wise Stuff Invoices</div>
			...
			<div id = "shop_address_test" style="font-size: 13px;">Stuff Name: <?php echo $username; ?> </div>
			<?php }
			?>
	...
	<div class="CSSTableGenerator"  style="margin:10px 0px;padding:0; width: 98%;">
		<table>
			...
			<?php
				...
				$total_received = 0;
				$total_due = 0;
				foreach($stuff_summery_setups -> result() as $field):
			?>
			<tr>
				<td> <?php echo $index; ?> </td>
				<td> <?php echo $field -> order_id; ?> </td> 
				
		        <td style="text-align:left"> <?php echo $field -> stuff_name; ?>  </td>
				...
				<td style = " text-align:right;">
					<?php 
						$due_amnt = $grand_total - $field -> paid_amount;
						$total_due += $due_amnt;
						echo '<big style = "font-size: 11px; font-weight:bold;"> &#2547; </big> '.round($due_amnt,2);
