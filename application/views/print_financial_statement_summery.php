...
<html>
	...
	<body onload="window.print()"  style="width: 790px;background: #ffffff;">
	
	<div class="form_field_seperator">
			<center>
				<div class ="financial__report" style="font-size: 18px;"><?php echo $this->tank_auth->get_hotel_name();?></div>
	...
	<div id = "mid_box_left" >
		<div class = "TitleBox">
			...
			<div class = "Field_Container_Box" >
				...
				<?php 
					echo '<div class = "h8">'.nbs(6).'<big style = "font-size: 11px; font-weight:bold;"> &#2547; </big> ';
					$cash_in_hand = $paid_amount - $total_expense;
