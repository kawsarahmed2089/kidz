...
<body>
	<div id="shop_title_box" style="margin-left:0px ;padding:0; width: 98%;">			
			...
			<div id = "shop_address_test" style="font-size: 16px;">Date Wise Complementary Invoices</div>
	...
	<div class="CSSTableGenerator"  style="margin:10px 0px;padding:0; width: 98%;">
		<table>
			...
			<?php
				...
				$total_receivable = 0;
				$total_received = 0;
				foreach($complementary_setups -> result() as $field):
			?>
			<tr>
				...
				<td style="text-align:center"> <?php echo $field -> room_number; ?>  </td>
