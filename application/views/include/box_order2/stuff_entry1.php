      <div class="container-fluid internal_title"><strong>New Stuff Entry</strong></div>
      
       <div class="container-fluid internal_box2 internal_fistb">
       <form role="form" id="stuff_entry_forms" enctype="multipart/form-data" method="POST" action="<?php echo base_url();?>index.php/site_controller/stuff_save">
       <div class="seperat15"></div>
       <div class="row">
       <div class="col-md-12">
		<div class="input-group input-group-lg">
		  <span class="input-group-addon">Name: </span>
		  <input type="text" id="stuff_nam" name="stuffName" class="form-control" placeholder="Stuff Name" required="required">
		</div>
       </div>
       </div>
	   <div class="seperat15"></div>
       ...
       <div class="col-md-6">
		<div class="input-group input-group-lg">
		  ...
		  <!--<input type="text" name="resignation" class="form-control" placeholder="Designation"> -->
		  <select name="resignation" class="form-control">
      ...
      <div class="row border_bottom border_top">
       ...
       <span id="stuff_entry_msge"></span>
       </div>
       <div class="col-md-5 text-right">
       <div class="seperat5"></div>
       <button type="submit" class="btn btn-success btn-lg"><i class="fa fa-plus-square"></i> Save</button>
       <button type="reset" class="btn btn-danger btn-lg" id="stuff_entry_cencel"><i class="fa fa-times"></i> Cancel</button>
       <div class="seperat5"></div>
       </div>
