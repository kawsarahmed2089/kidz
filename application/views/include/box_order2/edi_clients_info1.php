<div class="container-fluid internal_title"><strong>Edite Clients Information</strong></div>
      <div class="container-fluid internal_box2 internal_fistb">
      <form id="edi_clients_info_from" role="form" method="POST" action="<?php echo base_url();?>index.php/site_controller/edi_client_info">
      <input type="hidden" name="edi_key"/>
      <div class="row">
      ...
      <div class="row border_bottom border_top">
       ...
       <span class="massage_client_info_edi"></span>
       </div>
