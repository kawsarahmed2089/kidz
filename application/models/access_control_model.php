...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	class Access_control_model extends CI_model{
		...
		function seller_site_controller( $function_name )
		{
			switch( $function_name ){
				case 'expense_save' : return false;
				case 'expense_show' : return false;
				case 'expens_delete' : return false;
				case 'salary_entry_save' : return false;
				case 'salary_show' : return false;
				case 'salary_delete' : return false;
				case 'specific_salary_log_shoing' : return false;
			    default	: return true;
			}
		}
		...
		function my_access($user_type, $controller_name, $function_name)
		{
			...
			else if( $user_type == 'seller')
			{
				switch( $controller_name ){
					...
					case 'sale_controller'				: return true;
					case 'site_controller'				: return $this -> seller_site_controller( $function_name );
					default 							: return false;
				}
			}
			else return false;
		...
		function get_user_authentication($user_type){
			$this->db->from('rest_access_auth');
