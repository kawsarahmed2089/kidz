<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); 
	class Site_model extends CI_model{
		 ...
		 {
		 	$query = $this -> db -> select('product_info.product_id, product_info.product_name,
												bulk_stock_info.stock_amount, bulk_unit_sale_price AS unit_sale_price, last_buy_price,
		 ...
		 *
		 ...
		 function products_special_information($product_id , $shop_id)
		 {
		 	...
		 	return $this -> db -> query("
											...
											,bulk_unit_sale_price,bulk_stock_info.stock_amount as available_stock
											...
											bulk_unit_buy_price,bulk_unit_sale_price,bulk_stock_info.stock_amount as available_stock
		 ...
		 *this fuction fetch's all stock id of an specific product(Individual)
		 ...
		 function makeBarcode($product_id,$product_name, $product_specification,$sale_price,$all_selected_stock_list)
		 {
