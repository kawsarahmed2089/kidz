...
class Tank_auth
{
				...
				if ($hasher->CheckPassword($password, $user->password)) {		// password ok
					...
					if ($user->banned == 1) {									// fail - banned
						...
						$this->ci->session->set_userdata(array(
								...
								'hotel_contact' => $user -> hotel_contact,
	...
	function login_for_pos_terminal($login, $password, $remember, $login_by_username, $login_by_email)
	{
		if ((strlen($login) > 0) AND (strlen($password) > 0)) {
	...
	*****************************************/
	...
	{
		$this -> ci -> session -> set_userdata(array(
								'currrent_temp_sale_id'	=> $temp_sale_id
						));
	}
	/*******************************
	...
	********************************/
	...
	{
		return $this->ci->session->userdata('hotel_id');
	}
	function get_hotel_name()
	{
		return $this->ci->session->userdata('hotel_name');
	}
	...
	function get_hotel_contact()
	{
		return $this->ci->session->userdata('hotel_contact');
	}
	...
	{
		return $this->ci->session->userdata('hotel_address');
	}
	/**
	...
	{
		//$name = $this->input->post('ch_id');
		//echo $name; echo $newpass;
