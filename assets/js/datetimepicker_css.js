...
var WeekHeadColor = "#00a0ff"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#83d1ff"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#83d1ff"; //Background color of Saturday.
var WeekDayColor = "#dbf2ff"; //Background color of weekdays.
...
var HoverColor = "#9c9c9c"; //color when mouse move over.
...
var imageFilesPath = "images/date_picker/";
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	   ...
	   // }
	    //else {
	        vCalClosing += "<span id='close_cal' title='close'onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");stopSpin();' onmouseover='changeBorder(this, 0)'onmouseout='changeBorder(this, 1)' style='border:1px solid white; font-family: Arial;font-size: 10pt;'>Close</span></td>";
	    //}
	    vCalClosing += "</tr>";
	}
